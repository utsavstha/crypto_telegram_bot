...
BOT_LANGUAGE = "solar_es"
TOKEN = "6258888737:AAGaMKSkXRwFdl9oBQi_yuRb7kgGHjX5AVQ"
        ...
        if code == 201:
            ...
            keyboard = [
                [InlineKeyboardButton(
                    "QUIERO MULTIPLICAR MI CAPITAL", callback_data="0")],
            ]
...
async def welcome(query):
    ...
    reply_markup = InlineKeyboardMarkup(keyboard)
    file = open('files/solar_es_intro.mp4', 'rb')
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if query.data == "0":
        ...
        reply_markup = InlineKeyboardMarkup(keyboard)
        file = open('files/solar_es_energy.pdf', 'rb')
